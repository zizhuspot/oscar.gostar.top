...
> OscarTech is an English-language website dedicated to providing insightful and informative articles on a wide range of tech-related topics. Our goal is to keep our readers updated with the latest trends, innovations, and developments in the world of technology.
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhuspot/oscar.gostar.top.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
